...
export const CreateFormInteraction = {
...
export const FabricInteractions = {
    args: {
        fabrics: sampleFabrics,
        errors: [],
        isCreating: false,
...
export const WithDriftIndicators = {
...
export const MultiFabricWorkspace = {
...
export const StatePreservationScenario = {
...
export const AdvancedErrorScenarios = {
...
export const ConcurrentOperations = {
