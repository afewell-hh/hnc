...
describe('WorkspaceMachine', () => {
    ...
    describe('fabric selection', () => {
        ...
        beforeEach(() => {
            ...
            const fabric = actor.getSnapshot().context.fabrics[0];
            if (!fabric)
                throw new Error('Fabric not created in test setup');
            fabricId = fabric.id;
        });
    ...
    describe('fabric deletion', () => {
        ...
        beforeEach(() => {
            ...
            if (fabrics.length < 2)
                throw new Error('Fabrics not created in test setup');
    ...
    describe('navigation', () => {
        it('should return to listing state when BACK_TO_LIST is sent', () => {
            ...
            const fabric = actor.getSnapshot().context.fabrics[0];
            if (!fabric)
                throw new Error('Fabric not created');
    ...
    describe('fabric status updates', () => {
        ...
        it('should update fabric status and lastModified timestamp', () => {
            ...
            if (!initialTimestamp)
                throw new Error('No initial timestamp');
        ...
        it('should only update the specified fabric', () => {
            ...
            if (!fabric2)
                throw new Error('Second fabric not created');
