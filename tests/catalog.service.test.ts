...
describe('CatalogService', () => {
  describe('getSwitchModel', () => {
    ...
    it('should return null for non-string input', () => {
      const model = CatalogService.getSwitchModel(null as any)
      expect(model).toBeNull()
      
      const model2 = CatalogService.getSwitchModel(123 as any)
  ...
  describe('getEndpointProfile', () => {
    ...
    it('should return null for non-string input', () => {
      const profile = CatalogService.getEndpointProfile(null as any)
      expect(profile).toBeNull()
    })
  })
  ...
  describe('Edge Cases and Error Handling', () => {
    it('should handle undefined inputs gracefully', () => {
      expect(CatalogService.getSwitchModel(undefined as any)).toBeNull()
      expect(CatalogService.getEndpointProfile(undefined as any)).toBeNull()
    })

    it('should handle null inputs gracefully', () => {
      expect(CatalogService.getSwitchModel(null as any)).toBeNull()
      expect(CatalogService.getEndpointProfile(null as any)).toBeNull()
    })

    it('should handle number inputs gracefully', () => {
      expect(CatalogService.getSwitchModel(123 as any)).toBeNull()
      expect(CatalogService.getEndpointProfile(456 as any)).toBeNull()
    })

    it('should handle object inputs gracefully', () => {
      expect(CatalogService.getSwitchModel({} as any)).toBeNull()
      expect(CatalogService.getEndpointProfile([] as any)).toBeNull()
    })
