import{w as r,e as a,u as t}from"./index-Dmdg8KjP.js";import{A as h}from"./App-CnzeH_M7.js";import"./DriftIndicator-1SzGZTX-.js";import"./index-C3JiJ1qr.js";import"./iframe-TXMZdKjn.js";import"./FabricList-uA2FlVB8.js";import"./DriftSection-CESTiHQZ.js";const R={title:"HNC/App",component:h,parameters:{layout:"fullscreen",docs:{description:{component:"HNC v0.2 multi-fabric workspace application. Routes between fabric list and individual fabric designer based on workspace state."}}},tags:["ci"]},u={name:"Empty Workspace - No Fabrics",play:async({canvasElement:n})=>{const e=r(n);await a(e.getByText("No fabrics created yet")).toBeInTheDocument(),await a(e.getByText("Create your first fabric to get started with network design")).toBeInTheDocument();const o=e.getByRole("button",{name:"Create New Fabric"});await a(o).toBeInTheDocument(),await a(o).toBeEnabled()},parameters:{docs:{description:{story:"Initial state when no fabrics exist. Shows empty workspace with create fabric prompt."}}}},m={name:"Workspace with Multiple Fabrics",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Production Network");const c=e.getByRole("button",{name:"Create"});await t.click(c),await a(e.getByText("Your Fabrics (1)")).toBeInTheDocument(),await a(e.getByText("Production Network")).toBeInTheDocument(),await a(e.getByText("Draft")).toBeInTheDocument()},parameters:{docs:{description:{story:"Workspace showing fabric list with created fabrics. Demonstrates fabric creation flow and listing."}}}},p={name:"Single Fabric Design Mode",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Test Fabric");const c=e.getByRole("button",{name:"Create"});await t.click(c);const s=e.getByRole("button",{name:"Select"});await t.click(s),await a(e.getByText("HNC Fabric Designer v0.2")).toBeInTheDocument(),await a(e.getByText("← Back to List")).toBeInTheDocument();const l=e.getByDisplayValue("");await a(l).toBeInTheDocument(),await a(e.getByText("Compute Topology")).toBeEnabled()},parameters:{docs:{description:{story:"Fabric designer mode showing single fabric configuration and compute interface. Includes navigation back to workspace."}}}},w={name:"Create New Fabric Workflow",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o),await a(e.getByText("Create New Fabric")).toBeInTheDocument();const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Development Environment");const c=e.getByRole("button",{name:"Create"});await t.click(c),await a(e.getByText("Development Environment")).toBeInTheDocument(),await a(e.getByText("Draft")).toBeInTheDocument(),await a(e.getByRole("button",{name:"Select"})).toBeInTheDocument(),await a(e.getByRole("button",{name:"Delete"})).toBeInTheDocument()},parameters:{docs:{description:{story:"Complete workflow for creating a new fabric from empty workspace to fabric list."}}}},d={name:"Workspace Navigation Flow",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Navigation Test");const c=e.getByRole("button",{name:"Create"});await t.click(c);const s=e.getByRole("button",{name:"Select"});await t.click(s),await a(e.getByText("HNC Fabric Designer v0.2")).toBeInTheDocument();const l=e.getByText("← Back to List");await t.click(l),await a(e.getByText("Your Fabrics (1)")).toBeInTheDocument(),await a(e.getByText("Navigation Test")).toBeInTheDocument()},parameters:{docs:{description:{story:"Demonstrates navigation between workspace fabric list and individual fabric designer."}}}},y={name:"Workspace with Drift Detection",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Drift Test Fabric");const c=e.getByRole("button",{name:"Create"});await t.click(c);const s=e.getByRole("button",{name:"Select"});await t.click(s),await a(e.getByText("HNC Fabric Designer v0.2")).toBeInTheDocument(),await a(e.getByText("Drift Status")).toBeInTheDocument(),await a(e.getByRole("button",{name:"Check for Drift"})).toBeInTheDocument()},parameters:{docs:{description:{story:"Shows drift detection functionality integrated into the fabric designer workflow."}}}},B={name:"Workspace Error States",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByRole("button",{name:"Create"});await a(i).toBeDisabled();const c=e.getByPlaceholderText("Enter fabric name...");await t.type(c,"Valid Name"),await a(i).toBeEnabled(),await t.click(i),await a(e.getByText("Valid Name")).toBeInTheDocument()},parameters:{docs:{description:{story:"Demonstrates error handling in the workspace, including validation errors and recovery."}}}},f=async n=>{const e=await n.queryByRole("button",{name:/Create.*Fabric/i});if(e){await t.click(e);const i=await n.findByPlaceholderText("Enter fabric name...");await t.clear(i),await t.type(i,"v01"),await t.click(await n.findByRole("button",{name:/^Create$/i}))}const o=await n.findByRole("button",{name:"Select"});await t.click(o),await n.findByRole("combobox",{name:/Leaf model/i}),await t.selectOptions(await n.findByRole("combobox",{name:/Leaf model/i}),await n.findByRole("option",{name:/^DS2000$/i})),await n.findByRole("spinbutton",{name:/Uplinks per leaf/i}),await n.findByRole("button",{name:/Compute/i}),await n.findByLabelText(/Fabric Name:/i),await n.findByLabelText(/Uplinks Per Leaf:/i),await n.findByLabelText(/Endpoint Count:/i)},b={name:"v0.1 Compatibility - Computed Preview",tags:["ci"],play:async({canvasElement:n})=>{const e=r(n);await f(e);const o=await e.findByLabelText(/Uplinks Per Leaf:/i);await t.clear(o),await t.type(o,"4");const i=await e.findByLabelText(/Endpoint Count:/i);await t.clear(i),await t.type(i,"100"),await t.click(await e.findByRole("button",{name:/Compute/i})),await a(await e.findByText(/leaves needed:/i)).toBeInTheDocument(),await a(await e.findByText(/spines needed:/i)).toBeInTheDocument()},parameters:{docs:{description:{story:"Legacy v0.1 compute workflow with stable selectors and proper navigation."}}}},v={name:"v0.1 Compatibility - Invalid Uplinks",play:async({canvasElement:n})=>{const e=r(n),o=e.getByRole("button",{name:"Create New Fabric"});await t.click(o);const i=e.getByPlaceholderText("Enter fabric name...");await t.type(i,"Validation Test");const c=e.getByRole("button",{name:"Create"});await t.click(c);const s=e.getByRole("button",{name:"Select"});await t.click(s);const l=e.getByDisplayValue("2");await t.clear(l),await t.type(l,"5"),await t.click(e.getByText("Compute Topology"));const T=e.getAllByText(/uplinks per leaf must be/i);await a(T.length).toBeGreaterThan(0)},parameters:{docs:{description:{story:"Legacy v0.1 validation error handling in v0.2 workspace context."}}}},g={name:"v0.1 Compatibility - Save After Compute",tags:["ci"],play:async({canvasElement:n})=>{const e=r(n);await f(e),await t.clear(await e.findByLabelText(/Uplinks Per Leaf:/i)),await t.type(await e.findByLabelText(/Uplinks Per Leaf:/i),"4"),await t.clear(await e.findByLabelText(/Endpoint Count:/i)),await t.type(await e.findByLabelText(/Endpoint Count:/i),"100"),await t.click(await e.findByRole("button",{name:/Compute/i})),await a(await e.findByText(/leaves needed:/i)).toBeInTheDocument(),await a(await e.findByText(/spines needed:/i)).toBeInTheDocument(),await t.click(await e.findByRole("button",{name:/Save.*FGD/i})),await a(await e.findByText(/saved to fgd successfully/i)).toBeInTheDocument()},parameters:{docs:{description:{story:"Legacy v0.1 save workflow with stable selectors and proper save verification."}}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
